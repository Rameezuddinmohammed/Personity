...
const content = [
  {
    ...
    content: (
      <div className="h-full w-full bg-white dark:bg-zinc-900 rounded-xl p-8 flex flex-col justify-center space-y-6">
        <div className="space-y-3">
          <div className="h-2 w-24 bg-neutral-100 dark:bg-zinc-800 rounded-full" />
          <div className="h-2 w-full bg-neutral-100 dark:bg-zinc-800 rounded-full" />
          <div className="h-2 w-3/4 bg-neutral-100 dark:bg-zinc-800 rounded-full" />
        </div>
        <div className="p-5 bg-neutral-50 dark:bg-zinc-800 rounded-xl border border-neutral-200 dark:border-zinc-700">
        ...
        <div className="flex gap-3">
          <div className="h-10 w-24 bg-blue-600 dark:bg-blue-500 rounded-lg" />
          <div className="h-10 w-24 bg-neutral-100 dark:bg-zinc-800 rounded-lg" />
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="h-full w-full bg-neutral-50 dark:bg-zinc-900 rounded-xl p-8 flex flex-col justify-between">
        {/* Chat UI Mockup */}
        <div className="space-y-4">
          <div className="flex justify-start">
            <div className="bg-white dark:bg-zinc-800 border border-neutral-200 dark:border-zinc-700 p-4 rounded-2xl rounded-tl-none text-sm text-neutral-700 dark:text-neutral-300 max-w-[85%] shadow-sm">
              How did you find the onboarding process?
            </div>
          </div>
          <div className="flex justify-end">
            <div className="bg-blue-600/10 dark:bg-blue-500/20 text-blue-900 dark:text-blue-300 p-4 rounded-2xl rounded-tr-none text-sm max-w-[85%]">
              It was okay, kinda confusing.
            </div>
          </div>
          <div className="flex justify-start">
            <div className="bg-white dark:bg-zinc-800 border border-neutral-200 dark:border-zinc-700 p-4 rounded-2xl rounded-tl-none text-sm text-neutral-700 dark:text-neutral-300 max-w-[85%] shadow-sm">
              <span className="text-blue-600 dark:text-blue-400 font-semibold text-xs uppercase block mb-2">
                Adaptive Probe
              </span>
        ...
        <div className="h-12 bg-white dark:bg-zinc-800 border border-neutral-200 dark:border-zinc-700 rounded-xl flex items-center px-4 text-neutral-400 dark:text-neutral-500 text-sm mt-6">
          Type your response...
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="h-full w-full bg-white dark:bg-zinc-900 rounded-xl p-8 flex flex-col gap-6">
        ...
        <div className="space-y-4">
          <div>
            <div className="flex justify-between text-sm mb-2">
              ...
              <span className="text-neutral-500 dark:text-neutral-400">45%</span>
            </div>
            <div className="h-2 w-full bg-neutral-100 dark:bg-zinc-800 rounded-full overflow-hidden">
              <div className="h-full bg-blue-600 dark:bg-blue-500 w-[45%]" />
            </div>
          </div>
          <div>
            <div className="flex justify-between text-sm mb-2">
              ...
              <span className="text-neutral-500 dark:text-neutral-400">32%</span>
            </div>
            <div className="h-2 w-full bg-neutral-100 dark:bg-zinc-800 rounded-full overflow-hidden">
              <div className="h-full bg-blue-400 dark:bg-blue-400 w-[32%]" />
            </div>
          </div>
          <div className="p-4 bg-neutral-50 dark:bg-zinc-800 rounded-xl border border-neutral-100 dark:border-zinc-700">
            <div className="text-xs text-neutral-400 dark:text-neutral-500 uppercase font-bold mb-2">
              Key Insight
            </div>
            <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
